        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <?php
    $profid = $_GET['profid'];
    $query = mysql_query("SELECT * FROM maintenanceprofile WHERE userid = $profid ") or die(mysql_error());
    ...
    ?>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="bdate" value="<?php echo $birthdate; ?>" id="bdate" placeholder="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="" class="form-control" name="contact" onkeypress="return IsNumeric(event);" value="<?php echo $cellphone; ?>" ondrop="return false;" id="contact" placeholder="" maxlength="11">
                      <p class="help-block">
                      Example: 09123456789
...
<!-- Modal -->
        ...
        if(isset($push)){
          $reqsql= "UPDATE `maintenanceprofile` SET `fname`='$fname',`lname`='$lname',`birthdate`='$birthdate',`email`='$emailad',`cellphone`='$contact',`gender`='$gender',`address`='$address' WHERE userid ='$profid' ";
      ...
      <script type='text/javascript'>alert('Request for Service Updated.'); window.location.href = 'personnelview.php?profid=<?php echo $profid; ?>';</script>

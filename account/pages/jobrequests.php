      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-briefcase"></i> <span>Jobs</span></a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <?php
                            $sql = mysql_query("SELECT * FROM `jobrequest` as job JOIN `profiles` as prof JOIN `office` as o ON job.profileid=prof.profileid and prof.officeid=o.officeid WHERE reqstatus='purchase' OR reqstatus='materialsapprove' OR reqstatus='materialsordered' OR reqstatus='materialsdelivered'") or die(mysql_error());
    ...
    while($row = mysql_fetch_array($sql)){
      extract($row);
        ...
        <tr>
            ...
            <td><?php echo ucfirst($row['jobname']); ?></td>
            ...
            <td>
                ...
                $status=$row['reqstatus'];
                    switch ($status) {
                                        ...
                                        echo "<span class='label label-success'>Materials Ordered</span>";
                                        break;
                                        case "materialsdelivered":
                                        echo "<span class='label label-success'>Materials Delivered</span>";
                                        break;
                                        case "materials":
                                        ...
                                        echo "<small class='label label-primary'>Waiting for Materials</small>";
                                        break;
                                        case "ready":

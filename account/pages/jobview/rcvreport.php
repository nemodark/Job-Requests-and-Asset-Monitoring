...
<html>
   ...
   <!-- Bootstrap 3.3.4 -->
    ...
    <body class="skin-blue sidebar-mini" id="target">
    <!-- Site wrapper -->
    <?php
      ...
      <?php  
       ...
       ?>
        ...
        <section class="content-header">
          <h1>
            Receving Report
            <small><?php echo "#".$refnumber; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Receiving Reports</li>
          </ol>
        </section>
...
?>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
             <a href="printreport.php?rcvid=<?php echo $rcvreportid; ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
              <?php 
              switch ($reqstatus) {

...
include "../timeago.php";
    while($row = mysql_fetch_array($sql)){
      extract($row);  
        ...
        echo "<a href='./jobview/jobview.php?jobid=".$jobid."'>".ucfirst($jobname)."<br><i class='fa fa-clock-o'></i>".time_ago($jobdatereq)."</a>";
        $num++;
                            }
                          }
                        ?>
                  ...
                  <li class="footer"><a href="jobrequests.php">View all</a></li>
                </ul>
              </li>

...
<html>
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              ...
              <?php
    $vara = $_GET['key'];
    $query = mysql_query("SELECT * FROM materials WHERE materialid = $vara ") or die(mysql_error());
  ...
  while($rget = mysql_fetch_array($query)){
    ...
    ?>
          ...
          <input class="form-control" name="itemname" value="<?php echo $materialname; ?>" id="itemname" placeholder="">
          </div>
          <div class="form-group">
          <label>Description</label>
          <input class="form-control" name="itemdesc" id="itemdesc" value="<?php echo $materialdesc; ?>" placeholder="">
          </div>
          <div class="form-group">
          <div class="form-inline">
          <label>Quantity</label>
          <input class="form-control" type="number" name="itemqty" value="<?php echo $materialqty; ?>" id="itemqty" placeholder="">
          <label>Unit</label>
          <input class="form-control" type="text" name="unit" value="<?php echo $qtyunit; ?>" id="unit" placeholder="">
          <label>Cost</label>
          <input class="form-control" type="text" name="cost" value="<?php echo $materialcost; ?>" id="cost" placeholder="">
          </div>
          </div>
          <div class="form-group">
          <label>Date Needed</label>
          <input class="form-control" type="date" value="<?php echo $dateneeded; ?>" name="dateneed" id="dateneed" placeholder="">
          </div>
          <hr>
          <div class="col-xs-offset-5">
          
          <input type="submit" class="btn btn-primary" name="req" value="Save">
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <a href="../materials.php" type="button" class="btn btn-danger">Yes</a>
        ...
        if(isset($req)){
          ...
          $reqsql= "UPDATE materials SET materialname = '$itemname', materialdesc = '$itemdesc', materialqty ='$itemqty', qtyunit ='$unit', dateneeded = '$dateneed' , materialcost ='$cost', subtotal='$subtotal' WHERE materialid ='$vara' ";
          $result = mysql_query($reqsql) or die("Verification Error: " . mysql_error());
          
          if($result)
          {

        echo "<script type='text/javascript'>alert('Material Updated.'); window.location.href = '../materials.php';</script>";

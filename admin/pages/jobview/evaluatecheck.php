  ...
  <body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="col-md-10 col-md-offset-1">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <input type="submit" class="btn btn-success" name="req" value="Continue">
                  </div>
                  </div>
        ...
        if(isset($req)){
          $evaluation = mysql_query("SELECT * FROM jobrequest WHERE jobid='$jobid'");  
          $result = mysql_num_rows($evaluation);      
          if($result == $result)
          {

            ?>

    <script type='text/javascript'>alert('Success!.'); window.location.href = "jobview.php?jobid=<?php echo $jobid; ?>";</script>
        
           <?php 
        
    }
           else{
    echo "<script type='text/javascript'>alert('Inavalid code!')</script>";
}
        }
  ?>
      </div><!-- /.content-wrapper -->

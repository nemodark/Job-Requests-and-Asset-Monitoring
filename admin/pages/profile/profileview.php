...
<html>
   ...
   <!-- Bootstrap 3.3.4 -->
    ...
    <aside class="main-sidebar">
      ...
      <?php 
         $sql = mysql_query("SELECT * FROM `profiles` as prof JOIN `office` as o JOIN users as u ON prof.officeid=o.officeid AND prof.userid=u.userid WHERE prof.profileid = $profid") or die(mysql_error());
...
?>
          ...
          <h3>
             ...
             <div class="box-body"> 
             <?php
                            $sql = mysql_query("SELECT * FROM `jobrequest` WHERE profileid='$profid'") or die(mysql_error());
                            ...
                            if($result == '0'){
                              ...
                              <div class="col-xs-12">
                              <?php
                            echo "<p class='lead'>No Records</p>";

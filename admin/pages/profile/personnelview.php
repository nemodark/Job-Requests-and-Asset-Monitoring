   ...
   <!-- Bootstrap 3.3.4 -->
    ...
    <aside class="main-sidebar">
      ...
      <div class="content-wrapper">
        ...
        <a href="editpersonnel.php?profid=<?php echo $profid; ?>"><i class="fa fa-pencil-square-o"></i> Edit Profile</a>
        <a href="deletepersonnel.php"><i class="fa fa-trash-o"></i> Delete User</a>
        </div>
        </div>

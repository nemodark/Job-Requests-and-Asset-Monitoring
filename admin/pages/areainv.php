    ...
    while($row = mysql_fetch_array($sql)){
      extract($row);
        ?>
                    ...
                    <td><a href ="./inventory/areainvsystem.php?invsyid=<?php echo $invsyid; ?>&&locationid=<?php echo $locationinvid; ?>" ><i class="fa fa-mail-forward"> View</i></a></td>
                    </tr>
                    <?php
                          $num++;
                            }
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <input type="submit" class="btn btn-primary" name="addinvsy" value="Submit">
        ...
        error_reporting(0);
        extract($_POST);
        $checksy = mysql_query("SELECT * FROM invschoolyr WHERE schoolyr = '$syfrom - $syto' AND semester='$sems'");
        
        if(isset($addinvsy)){
          if(mysql_num_rows($checksy)==0){
          $reqsql= "INSERT INTO `invschoolyr`(`userid`, `schoolyr`, `semester`) VALUES ('$userid','$syfrom - $syto','$sems')";

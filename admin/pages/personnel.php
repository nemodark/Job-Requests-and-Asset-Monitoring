          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="./personnel.php"><i class="fa fa-circle-o"></i> Personnel</a></li>
              </ul>
            </li>
          </ul>
        </section>
      ...
      extract($row);
        ...
        <tr>
            ...
            switch ($personnelstatus) {
                                        ...
                                        break;
                                        case "working":
                                        echo "<small class='label label-info pull-right'>Working</small>";
                                        break;
                                        case "absent":
                                        echo "<small class='label label-success pull-right'>absent</small>";
                                        break;
                                        }

    ...
    while($row = mysql_fetch_array($sql)){
      extract($row);
        ...
        <tr>
            ...
            <td>
            <a href ="./areas.php?schoolbldgid=<?php echo $schoolbldgid; ?>" ><i class="fa fa-mail-forward"> View</i></a>
            </td>
        <?php
        $num++;
    }
...
$insertbldg = mysql_query("INSERT INTO `schoolbldg`(`schoolbldgname`) VALUES ('".addslashes($bldgname[$i])."')") or die("Verification Error: " . mysql_error());
 ...
 if($insertbldg)
        ...
        echo "<script type='text/javascript'>alert('Building Successfully added.'); window.location.href = 'locations.php';</script>";
